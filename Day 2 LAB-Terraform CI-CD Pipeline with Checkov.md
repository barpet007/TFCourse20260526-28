              ...
              steps:
                ...
                - task: TerraformTaskV4@4
                  ...
                  inputs:
                    ...
                    command: 'apply'
                    environmentServiceNameAzureRM: 'TF-SERVICE-CONNECTION'
                    commandOptions: 'tfplan' # apply using the saved plan
...
- create the module files in the repo (`modules/simple_storage/*`) with these exact snippets, or
- update the pipeline YAML in the repo directly, or
- run a local `checkov` scan on the example module and attach the JSON output.
